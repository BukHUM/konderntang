...
function konderntang_add_admin_menu()
{
    ...
    // Note: Hero Banners is added via register_post_type with 'show_in_menu' => 'konderntang'
    // It will be reordered by konderntang_reorder_admin_menu below
            ...
            <div class="konderntang-widget">
                ...
                <div class="konderntang-widget-content">
                    <div class="konderntang-stats-grid">
                        ...
                        <!-- Custom Post Types -->
                        <a href="<?php echo esc_url(admin_url('edit.php?post_type=travel_guide')); ?>"
                            class="konderntang-stat-item">
                            <div class="stat-icon" style="background: #14b8a6;">
                                <span class="dashicons dashicons-location-alt"></span>
                            </div>
                            <div class="stat-info">
                                <div class="stat-number"><?php echo number_format_i18n($travel_guide_count->publish); ?>
                                </div>
                                <div class="stat-label"><?php esc_html_e('Travel Guides', 'konderntang'); ?></div>
                            </div>
                        </a>
                        <a href="<?php echo esc_url(admin_url('edit.php?post_type=hotel')); ?>"
                            class="konderntang-stat-item">
                        ...
                        <a href="<?php echo esc_url(admin_url('edit.php?post_type=promotion')); ?>"
                            class="konderntang-stat-item">
                            <div class="stat-icon" style="background: #f59e0b;">
                                <span class="dashicons dashicons-tag"></span>
                            </div>
                            <div class="stat-info">
                                <div class="stat-number"><?php echo number_format_i18n($promotion_count->publish); ?>
                                </div>
                        ...
                        <!-- Taxonomies -->
                        <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=category')); ?>"
                            class="konderntang-stat-item">
                        ...
                        <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=post_tag')); ?>"
                            class="konderntang-stat-item">
                        ...
                        <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=destination&post_type=post')); ?>"
                            class="konderntang-stat-item">
                        ...
                        <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=travel_type&post_type=post')); ?>"
                            class="konderntang-stat-item">
...
function konderntang_docs_page()
{
    ...
    <div class="wrap">
        ...
        <div class="konderntang-docs"
            style="background: #fff; padding: 20px; border: 1px solid #ddd; border-radius: 8px; margin-top: 20px;">
            ...
            <p><?php esc_html_e('For more information, please refer to the theme documentation or contact support.', 'konderntang'); ?>
            </p>
        </div>
    </div>
    <?php
...
function konderntang_custom_fields_cleaner_page()
{
    ...
    <div class="wrap">
        ...
        <div class="notice notice-warning">
            <p><strong><?php esc_html_e('คำเตือน:', 'konderntang'); ?></strong>
                <?php esc_html_e('การลบ Custom Fields เป็นการกระทำที่ไม่สามารถย้อนกลับได้ กรุณาตรวจสอบให้แน่ใจก่อนลบ', 'konderntang'); ?>
            </p>
        </div>
        ...
        <form method="post" action="">
            ...
            <div style="margin: 20px 0;">
                <button type="submit" name="konderntang_delete_meta_keys" class="button button-primary"
                    onclick="return confirm('<?php esc_attr_e('คุณแน่ใจหรือไม่ว่าต้องการลบ Custom Fields ที่เลือก? การกระทำนี้ไม่สามารถย้อนกลับได้!', 'konderntang'); ?>');">
                            ...
                            <tr class="<?php echo esc_attr($status_class); ?>">
                                ...
                                <td>
                                    ...
                                    <?php if (in_array($item['key'], $theme_meta_keys)): ?>
                                        <span class="dashicons dashicons-yes-alt" style="color: #00a32a;"
                                            title="<?php esc_attr_e('ใช้ใน Theme', 'konderntang'); ?>"></span>
                                    <?php endif; ?>
                                </td>
